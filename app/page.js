...
const Navbar = ({ activeSection }) => {
    const linkClasses = (section) =>
        `transition-colors py-2 ${activeSection === section
        ...
        <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-sm">
            <nav className="container mx-auto px-6 py-4 flex justify-between items-center">
                ...
                <a
                    ...
                    className="bg-[#030067] text-white px-4 py-2 rounded-full flex items-center space-x-2 text-sm hover:opacity-90 transition-opacity"
                >
        ...
        <div className="scroll-smooth">
            ...
            >
                <div className="container mx-auto grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="bg-[#030067] text-white p-8 md:p-12 rounded-3xl shadow-2xl flex flex-col items-center text-center">
                        <img src="/signai-logo.png" alt="SignAI Logo" className="h-12 mb-6" />
            ...
            >
                <div className="container mx-auto">
                    <div className="bg-[#030067] text-white p-10 md:p-16 rounded-3xl shadow-2xl grid md:grid-cols-2 gap-12 items-center">
                        ...
                        <div>
                            ...
                            <ul className="space-y-4">
                                <li className="text-lg md:text-xl font-light">
            ...
            >
                <div className="container mx-auto grid md:grid-cols-2 gap-12 items-center">
                    <div className="bg-[#030067] text-white p-8 md:p-12 rounded-3xl shadow-2xl">
            ...
            <section id="about" ref={sectionRefs.about} className="bg-white py-20 px-6">
                <div className="container mx-auto">
                    <h2 className="text-4xl md:text-5xl font-light mb-12 text-[#030067]">
                        El equipo detrás de
                        <br />
                        <span className="font-bold">aquila:</span>
                    </h2>
                    <div className="bg-[#030067] text-white p-10 md:p-12 rounded-3xl shadow-2xl">
